...
export default function Privacy() {
  return (
    <>
      <Head>
        <title>Privacy Policy | DemanualAI</title>
        <meta name="description" content="Read DemanualAI's privacy policy to understand how we collect, use, and protect your data while providing our business automation services." />
      </Head>
