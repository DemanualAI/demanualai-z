...
export default function Contact() {
    ...
    return (
        <>
            <Head>
                <title>Contact Us | DemanualAI - Get Started with Automation</title>
                <meta name="description" content="Ready to automate your business processes? Contact DemanualAI for a free consultation. Our experts are here to help transform your operations with AI-powered solutions." />
            </Head>
            <section >
